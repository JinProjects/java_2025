...
<%-- 				<input type="text" class="form-control" id="username" name="username" value="<%=vo.getBname()%>" disabled="disabled"> --%>
			...
			<div class="my-3">
				...
				<input type="text" class="form-control" id="btitle" name="btitle" disabled="disabled">
			</div>
			<div class="my-3">
				<label for="bcontent">내용</label>
<%-- 				<textarea rows="5" cols="" class="form-control" id="bcontent" name="bcontent" ><%=vo.getBcontent() %></textarea> --%>
				<textarea rows="5" cols="" class="form-control" id="bcontent" name="bcontent"  disabled="disabled"></textarea>
			</div>
			<div class="d-grid gap-3">
				...
				<a href="/delete.do?bno=" class="btn btn-info btn-block text-white" id="btndelete">삭제</a>
